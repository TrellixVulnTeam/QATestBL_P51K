...
class Home():
    ...
    def __init__(self, myDriver):
        ...
        self.select_brand = (By.XPATH, "//span[contains(@class, 'cbx x-refine__multi-select-cbx') and text() = 'PUMA']")
        ...
        self.sort_op = (By.ID, 'w7')
        self.sort_price_as = (By.XPATH,"//a[contains(.,'Precio + Envío: más bajo primero')]")
        self.sort_price_desc = (By.XPATH, "//a[contains(.,'Precio + Envío: más alto primero')]")
